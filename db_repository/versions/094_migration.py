...
product = Table('product', post_meta,
    ...
    Column('subcategory_1', Unicode),
    Column('subcategory_2', Unicode),
    Column('subcategory_3', Unicode),
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['product'].columns['keywords'].create()
    post_meta.tables['product'].columns['long_desc'].create()
    post_meta.tables['product'].columns['subcategory_1'].create()
    post_meta.tables['product'].columns['subcategory_2'].create()
    post_meta.tables['product'].columns['subcategory_3'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['product'].columns['keywords'].drop()
    post_meta.tables['product'].columns['long_desc'].drop()
    post_meta.tables['product'].columns['subcategory_1'].drop()
    post_meta.tables['product'].columns['subcategory_2'].drop()
    post_meta.tables['product'].columns['subcategory_3'].drop()
