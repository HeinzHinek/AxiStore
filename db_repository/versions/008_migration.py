...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['product'].columns['maker'].drop()
    post_meta.tables['product'].columns['maker_id'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['product'].columns['maker'].create()
    post_meta.tables['product'].columns['maker_id'].drop()
